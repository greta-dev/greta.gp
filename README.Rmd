...
[![Codecov test coverage](https://codecov.io/gh/greta-dev/greta.gp/graph/badge.svg?token=sDr01k2p2r)](https://app.codecov.io/gh/greta-dev/greta.gp)
<!-- badges: end -->
...
Or install the development version of `greta.gp` from [r-universe](https://greta-dev.r-universe.dev/):
